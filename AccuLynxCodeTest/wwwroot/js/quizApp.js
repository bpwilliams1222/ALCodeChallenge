...
app.controller('GameSession', function ($scope, $http, $compile) {
    ...
    $scope.finishSession = function () {
        $http({
            ...
            //If server responds with true, the user data was saved/updated successfully
    ...
    function buildQuestionHTML(questionData) {
        ...
        //The above HTML doesn't need to be compiled because there are no angular click events, the below click event is registered with the angular controller as  result of being compiled
